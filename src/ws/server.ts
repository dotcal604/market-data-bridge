...
const VALID_CHANNELS = new Set(["positions", "orders", "account", "executions", "signals", "status", "inbox", "incidents"]);

type ChannelName = "positions" | "orders" | "account" | "executions" | "signals" | "status" | "inbox" | "incidents";
