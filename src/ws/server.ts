...
const VALID_CHANNELS = new Set(["positions", "orders", "account", "executions", "signals", "status", "eval_created", "journal_posted", "order_filled"]);

type ChannelName = "positions" | "orders" | "account" | "executions" | "signals" | "status" | "eval_created" | "journal_posted" | "order_filled";
