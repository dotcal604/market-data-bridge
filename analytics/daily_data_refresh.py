...
STEPS = [
    ...
    {
        "key": "economic_events",
        "name": "Economic Event Calendar (FOMC + NFP)",
        "script": SCRIPTS_DIR / "33_fetch_economic_events.py",
        "args": [],
        "cwd": HOLLY_DIR,
        "timeout_min": 2,
        "critical": False,
    ...
    {
        "key": "earnings",
        "name": "Earnings Calendar (Yahoo Finance)",
        "script": SCRIPTS_DIR / "34_fetch_earnings_calendar.py",
        "args": [],
        "cwd": HOLLY_DIR,
        "timeout_min": 60,
        "critical": False,
