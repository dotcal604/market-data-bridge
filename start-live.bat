...
:: ── Safety confirmation ──────────────────────────────────────────────
title Market Data Bridge — LIVE TRADING
cls
echo.
echo   ╔══════════════════════════════════════════════════╗
echo   ║    *** WARNING: LIVE TRADING MODE ***           ║
echo   ║    This connects to your REAL IBKR account.     ║
echo   ║    Real money. Real orders.                     ║
echo   ╚══════════════════════════════════════════════════╝
echo.
set /p CONFIRM="Type YES to continue with live trading: "
if /i not "%CONFIRM%"=="YES" (
    echo Aborted. Use start.bat for paper trading.
    pause
    exit /b 0
)
...
start "Market Data Bridge — Dashboard (LIVE)" cmd /k "cd /d "%~dp0\frontend" && npm run dev -- -p 3001"
